			...
			<div class="col-xs-12 col-md-4">
				<div class="text-center">
					<div class="margen-arriba">
						<div class="text-center">
							<h2 class="pl-5" align="left" style="color: #00bfdf">
...
<!-- 						<form class="formulario-bk m-lg-2 m-sm-5"> -->
						<form>
							<div class="form-row align-items-center px-3">
								<label for="exampleFormControlSelect1"><strong>Tipo
										de Almacenamiento</strong></label>
							...
							<div class="form-row px-3">
								<label for="exampleFormControlSelect1"><strong>Estado
										del contenedor</strong></label>
								<div class="col-12 mb-3"">
							...
							<div class="form-row px-3">
								<label for="exampleFormControlSelect1"><strong>Interseccion
										de calles</strong></label>
								<div class="col-12 mb-2">
									<input type="text" class="form-control" id="calleuno"
										aria-describedby="emailHelp" placeholder="Calle 1"> <input
										type="text" class="form-control mt-2" id="calledos"
										aria-describedby="emailHelp" placeholder="Calle 2">
								</div>
								<!-- 								<div class="col-12 col-md-4 mb-3"> -->
...
<!-- 										class="btn btn-dark" onclick="buscarGPS();" /> -->
							...
							<div class="form-row align-items-center px-3">
								...
								<label for="exampleFormControlSelect1"> <i
									class="fas fa-info-circle"></i> Haga doble-click sobre el mapa
									para buscar por Geolocalizacion
								</label>
							</div>
						</form>
						<!-- 						</div> -->
			...
			<div class="col-xs-12 col-md-8 pt-10" style="height: 100%;">
				<div id="map" class="map"
					style="width: 100%; height: 100%; min-height: 270px"></div>
				<button id="btnCho"
	...
	<script type="text/javascript">
		...
		var cordss = ol.proj.transform([ -56.162109, -34.909584 ], 'EPSG:4326',
				'EPSG:32721');
		...
		function showPosition(position) {
			...
			selectTipo.getFeatures().clear();
			var feats = selectTipo.getFeatures();
			var closestFeature = sourceWFS
					.getClosestFeatureToCoordinate(nuevap);
		...
		function showPositionDOS(position) {
			...
			selectTipo.getFeatures().clear();
			var feats = selectTipo.getFeatures();
			var closestFeature = seleccionados
					.getClosestFeatureToCoordinate(nuevap);
			feats.push(closestFeature);
		}
		...
		function buscarCalle() {
			...
			for (var a = 0; a < callea.length; a++) {
				var lineaturf = format.writeFeatureObject(callea[a], {
					'featureProjection' : 'EPSG:4326'
				});
				for (var b = 0; b < calleb.length; b++) {
					var lineaturfdos = format.writeFeatureObject(calleb[b], {
						'featureProjection' : 'EPSG:4326'
					});
					...
					if (ints.features.length/* ints != null */) {
						...
						var feats = selectTipo.getFeatures();
						var closestFeature = sourceWFS
								.getClosestFeatureToCoordinate(ints.features[0].geometry.coordinates);
						feats.push(closestFeature);
					}
				}
			}
				...
				.click(
						function() {
							...
							case 'btnEdit':
								...
								dirty = {};
								interactionSelect.getFeatures().on('add',
										function(e) {
